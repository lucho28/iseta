                ...
                @if (!$config['modo_seguro'])
                    <div>
                        <form id="form-eliminar-{{ $mesa->id }}"
                            action="{{ route('preceptor.mesas.destroy', ['mesa' => $mesa->id]) }}" method="POST"
    ...
    <div class="table">
        <div class="table__header">
            ...
            <div class="flex just-center">
                <a href="{{ route('preceptor.mesas.acta', ['mesa' => $mesa->id]) }}" target="_blank">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex; align-items: center; justify-content: center;"
                                ...
                                <form action="{{ route('preceptor.examenes.nota', ['examen' => $examen->id]) }}"
                                    method="POST">
                                    @csrf
                        ...
                        <td>
                            <div style="display:flex; align-items: center; justify-content: center;">
                                ...
                                <a class="flex items-center justify-center"
                                    href="{{ route('preceptor.cursadas.edit', ['cursada' => $cursada->id, 'mesa' => $mesa->id, 'from' => 'mesas']) }}">
