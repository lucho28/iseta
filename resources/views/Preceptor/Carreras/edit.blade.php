    ...
    <div class="edit-form-container">
        <div class="perfil_one br">
            ...
            <div class="perfil__info">
                <form method="POST" action="{{ route('preceptor.carreras.update', ['carrera' => $carrera->id]) }}"
                                                ...
                                                <tr
                                                    ...
                                                    <!-- <td>
                                                            <div
                                                                ...
                                                                <button class="btn_blue"
                                                                    onclick="window.location.href='{{ route('preceptor.mesas.dual', ['carrera' => $carrera->id, 'asignatura' => $asignatura->id]) }}'">
                                                    ...
                                                    <td class="center">
                                                        @if (!$config['modo_seguro'])
                                                            <form id="form-eliminar-{{ $asignatura->id }}"
                                                                action="{{ route('preceptor.carreras.destroyAsignatura', ['carrera' => $carrera->id, 'asignatura' => $asignatura->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div
